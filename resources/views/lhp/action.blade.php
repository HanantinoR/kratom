<div class="flex align-items-center list-user-action">
    <div class="row mt-2">
        <a href="{{route('lhp.sertifikat',$code_above_lhp)}}" target="_blank" class="btn btn-sm btn-icon btn-soft-success" data-toggle="tooltip" data-placement="top" title="Print">
