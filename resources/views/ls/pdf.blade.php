...
<head>
    ...
    <title>LS - {{$data['ls']->code_above}}</title>
    <style>
        body {
...
<body>
    <div class="container" style="font-size:11px">
        <table class="table">
            ...
            <tr>
                <td colspan="3"style="border-right:none; font-weight: bold;">A. KANTOR PENERBIT: {{$data['ls']->kantor_cabang}}</td>
                <td colspan="4" style="border-left:none; border-right:none; text-align:center;">Nomor: {{$data['ls']->code_above}}</td>
                <td colspan="3" style="border-left:none; text-align:center;">Tanggal: {{date('d F Y', strtotime($data['ls']->created_at))}}</td>
                {{-- <td style="border-right:none; font-weight: bold; padding-left: 10px; margin-left:10px" colspan="3">
                    A. KANTOR PENERBIT: {{$data['ls']->kantor_cabang}}
                </td>
                <td style="border-left:none; border-right:none; padding-left: 10px" colspan="3">Nomor: {{$data['ls']->code_above}}</td>
                <td style="border-left:none;" colspan="4">Tanggal: {{date('d F Y', strtotime($data['ls']->created_at))}}</td> --}}
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="6">No.PPBE: {{$data['ls']->code}}, Tanggal:{{date('d F Y', strtotime($data['ls']->code_date))}}</td>
            </tr>
            <tr>
                <td colspan="6">PEMERIKSAAN AWAL: {{$data['ls']->kantor_cabang}} Tanggal: {{date('d F Y', strtotime($data['ls']->inspection_date))}}</td>
            </tr>
            <tr>
                <td colspan="6" >PEMERIKSAAN AKHIR: {{$data['ls']->inspection_address}} Tanggal: {{date('d F Y', strtotime($data['ls']->stuffin_date))}}.</td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="10">
                    ...
                    <br>
                    Dapat Diekspor sesuai dengan ketentuan peraturan menteri perdagangan RI No. 23 Tahun 2023 & No. 21 Tahun 2024
                </td>
            </tr>
            <tr>
