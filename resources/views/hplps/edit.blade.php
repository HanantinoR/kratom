<x-app-layout :assets="$assets ?? []">
    <div class="">
        <?php
            ...
            $tps = ['1' => 'TPS MERAH','2' => 'TPS HIJAU','3' => 'LOCK SEAL','4' => 'THREAD SEAL'];
            $size = ['20' => '20', '40' => '40'];
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="origin_port_id" class="form-control select2" id="origin_port_id">
                                        <option value="">Pilih Pelabuhan Muat</option>
                                        @foreach($loading_port as $key => $port)
                                            <option value="{{ $port->id }}" @if(old('origin_port_id', $data->origin_port_id) == $port->id) Selected @endif>
                                                {{ $port->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="datetime-local" id="inspection_date_start" name="inspection_date_start" class="form-control text-black" value="{{ old('inspection_date_start', $data->hplps->inspection_date_start)}}" readonly>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="datetime-local" id="inspection_date_end" name="inspection_date_end" class="form-control text-black" value="{{ old('inspection_date_end', $data->hplps->inspection_date_end)}}" readonly>
                                    ...
                                    <table class="table form-table table-striped table-responsive-lg table-hover" role="grid" id="form_bcops_usage">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data->hplps->usage as $index => $usage)
                                                <tr>
                                                    <td>
                                                        {{-- {{ Form::text('usage[0][type]', old('usage[0][type]', $usage['type']), ['class' => 'form-control text-black', 'id' => 'usage[0][type]','required']) }} --}}
                                                        <select name="usage[{{$index}}][type]" class="form-control select2" id="usage[{{$index}}][type]" placeholder="Select FOB Currency" style="width:100%">
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3">
                                                                {{ Form::text('usage['.$index.'][series]', old('usage['.$index.'][series]', $usage['series']), ['class' => 'form-control text-black', 'id' => 'usage['.$index.'][series]','required']) }}
                                                            </div>
                                                            <div class="col-lg-3">
                                                                {{ Form::text('usage['.$index.'][init]', old('usage['.$index.'][init]', $usage['series_init']), ['class' => 'form-control text-black', 'id' => 'usage['.$index.'][init]','required']) }}
                                                            </div>
                                                            <div class="col-lg-1 mt-2">
                                                                S/D
                                                            </div>
                                                            <div class="col-lg-3">
                                                                {{ Form::text('usage['.$index.'][final]', old('usage['.$index.'][final]', $usage['series_final']), ['class' => 'form-control text-black', 'id' => 'usage['.$index.'][final]','required']) }}
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="datetime-local" id="stuffing_date_start" name="stuffing_date_start" class="form-control text-black" value="{{ old('stuffing_date_start',$data->hplps->stuffing_date_start)}}" readonly>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="datetime-local" id="stuffing_date_end" name="stuffing_date_end" class="form-control text-black" value="{{ old('stuffing_date_end', $data->hplps->stuffing_date_end)}}" readonly>
                            ...
                            <div class="row">
                                        ...
                                        <tbody>
                                            @foreach ($data->hplps->memory as $index => $memory)
                                                ...
                                                <td class="p-1 ">
                                                    ...
                                                    <select name="memorizations[{{$index}}][type]" class="form-control select2" id="memorizations[{{$index}}][type]" placeholder="Select FOB Currency" style="width:100%">
                                                        <option value="">Pilih Segel Kemas</option>
                                                            <option value="1" {{ old('memorizations['.$index.'][type]', $memory['type']) == 1 ? 'selected' : '' }}>TPS MERAH</option>
                                                            <option value="2" {{ old('memorizations['.$index.'][type]', $memory['type']) == 2 ? 'selected' : '' }}>TPS HIJAU</option>
                                                            <option value="3" {{ old('memorizations['.$index.'][type]', $memory['type']) == 3 ? 'selected' : '' }}>LOCK SEAL</option>
                                                            <option value="4" {{ old('memorizations['.$index.'][type]', $memory['type']) == 4 ? 'selected' : '' }}>THREAD SEAL</option>
                                                    </select>
                                                </td>
                                                <td class="p-1">
                                                        ...
                                                        <div class="lock_field" id="lock_field_0">
                                                            <div class="row">
                                                                <div class="col-md-8 col-lg-8">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-4 p-1">
                                                                            {{ Form::text('memorizations[0][lock_seal_series][0]', old('memorizations[0][lock_seal_series][0]'), ['class' => 'form-control text-black tps_0', 'id' => 'memorizations[0][lock_seal_series][0]', 'required','disabled']) }}
                                                                        </div>
                                                                        <div class="col-md-4 p-1">
                                                                            {{ Form::text('memorizations[0][lock_seal_init][0]', old('memorizations[0][lock_seal_init][0]'), ['class' => 'form-control text-black tps_0', 'id' => 'memorizations[0][lock_seal_init][0]', 'required','disabled']) }}
                                                                        </div>
                                                                        <div class="col-md-4 p-1">
                                                                            {{ Form::text('memorizations[0][lock_seal_final][0]', old('memorizations[0][lock_seal_final][0]'), ['class' => 'form-control text-black tps_0', 'id' => 'memorizations[0][lock_seal_final][0]', 'required','disabled']) }}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4 col-lg-4 mt-4">
                                                                    <div class="row">
                                                                        <div class="col-md-5 col-lg-5 mt-2 me-2 p-1">
                                                                            <button type="button" class="btn btn-sm btn-info btn_validasi_0_lock_0" target="0" id="btn_validasi_0_lock_0" disabled> Validasi</button>
                                                                        </div>
                                                                        <div class="col-md-2 mt-2 p-1">
                                                                            <span class="text-danger" id="status_validasi_0_lock_0" target="0">Error</span>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <button type="button" class="btn btn-sm btn-icon btn-warning  btn_lock_seal_0 mt-2" id="btn_lock_seal_0" name="btn_lock_seal[0]" target="0" disabled>
                                                                                <svg width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M7.33 2H16.66C20.06 2 22 3.92 22 7.33V16.67C22 20.06 20.07 22 16.67 22H7.33C3.92 22 2 20.06 2 16.67V7.33C2 3.92 3.92 2 7.33 2ZM12.82 12.83H15.66C16.12 12.82 16.49 12.45 16.49 11.99C16.49 11.53 16.12 11.16 15.66 11.16H12.82V8.34C12.82 7.88 12.45 7.51 11.99 7.51C11.53 7.51 11.16 7.88 11.16 8.34V11.16H8.33C8.11 11.16 7.9 11.25 7.74 11.4C7.59 11.56 7.5 11.769 7.5 11.99C7.5 12.45 7.87 12.82 8.33 12.83H11.16V15.66C11.16 16.12 11.53 16.49 11.99 16.49C12.45 16.49 12.82 16.12 12.82 15.66V12.83Z" fill="currentColor"></path>
                                                                                </svg>
                                                                            </button>
                                ...
                                <div class="form-group mt-4">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            ...
                                            @php
                                                $json_doc_hpl = json_decode($data->hplps->files_doc_hpl);
                                            @endphp
                                            @foreach ($json_doc_hpl as $key => $hpl)
                                                <ul>
                                                    <li>
                                                        <a href="{{asset('hplps_file/'.    $hpl)}}" target="_blank" class="btn btn-sm btn-icon btn-info">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <label for="" class="text-black">
                                                Foto Pemeriksaan Barang
                                            </label>
                                            @php
                                                $json_foto_pemeriksaan = json_decode($data->hplps->files_foto_pemeriksaan);
                                            @endphp
                                            @foreach ($json_foto_pemeriksaan as $key => $pemeriksaan)
                                                <ul>
                                                    <li>
                                                        <a href="{{asset('hplps_file/'.    $pemeriksaan)}}" target="_blank" class="btn btn-sm btn-icon btn-info">
                                                            <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M2 16.08V7.91C2 4.38 4.271 2 7.66 2H16.33C19.72 2 22 4.38 22 7.91V16.08C22 19.62 19.72 22 16.33 22H7.66C4.271 22 2 19.62 2 16.08ZM12.75 14.27V7.92C12.75 7.5 12.41 7.17 12 7.17C11.58 7.17 11.25 7.5 11.25 7.92V14.27L8.78 11.79C8.64 11.65 8.44 11.57 8.25 11.57C8.061 11.57 7.87 11.65 7.72 11.79C7.43 12.08 7.43 12.56 7.72 12.85L11.47 16.62C11.75 16.9 12.25 16.9 12.53 16.62L16.28 12.85C16.57 12.56 16.57 12.08 16.28 11.79C15.98 11.5 15.51 11.5 15.21 11.79L12.75 14.27Z" fill="currentColor"></path>
                                                            </svg>
                                                            Download Foto Pemeriksaan {{$key+1}}
                                                        </a>
                                                    </li>
                                                </ul>
                                            @endforeach
                                ...
                                <div class="form-group mt-2">
                                        <div class="col-lg-6 col-md-6">
                                            <label for="" class="text-black">
                                                Foto Pengawasan/Stuffing
                                            </label>
                                            @php
                                                $json_foto_pengawasan = json_decode($data->hplps->files_foto_pengawasan);
                                            @endphp
                                            @foreach ($json_foto_pengawasan as $key => $pengawasan)
                                                <ul>
                                                    <li>
                                                        <a type="button" href="{{asset('hplps_file/'.    $pengawasan)}}" target="_blank" class="btn btn-sm btn-icon btn-info">
                                                            <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M2 16.08V7.91C2 4.38 4.271 2 7.66 2H16.33C19.72 2 22 4.38 22 7.91V16.08C22 19.62 19.72 22 16.33 22H7.66C4.271 22 2 19.62 2 16.08ZM12.75 14.27V7.92C12.75 7.5 12.41 7.17 12 7.17C11.58 7.17 11.25 7.5 11.25 7.92V14.27L8.78 11.79C8.64 11.65 8.44 11.57 8.25 11.57C8.061 11.57 7.87 11.65 7.72 11.79C7.43 12.08 7.43 12.56 7.72 12.85L11.47 16.62C11.75 16.9 12.25 16.9 12.53 16.62L16.28 12.85C16.57 12.56 16.57 12.08 16.28 11.79C15.98 11.5 15.51 11.5 15.21 11.79L12.75 14.27Z" fill="currentColor"></path>
                                                            </svg>
                                                            Download Foto Pengawasan {{$key+1}}
                                                        </a>
                                                    </li>
                                                </ul>
                                            @endforeach
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    {{-- {{ Form::text('origin_port_id', old('origin_port_id', $loading_port[$data->origin_port_id]->name), ['class' => 'form-control text-black', 'id' => 'origin_port_id', 'readonly']) }} --}}
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="loading_port_id" class="form-label">Pelabuhan Muat: <span class="text-danger">*</span></label>
                                    <select name="loading_port_id" class="form-control text-black select2" id="loading_port_id" placeholder="Pelabuhan Muat" disabled>
                                ...
                                <div class="table-responsive">
                                    <table class="table form-table table-striped table-responsive-lg table-hover" role="grid" id="form_bcops_usage">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    {{-- {{ Form::text('usage[0][type]', old('usage[0][type]'), ['class' => 'form-control text-black', 'id' => 'usage[0][type]']) }} --}}
                                                    <select name="usage[0][type]" class="form-control select2" id="usage[0][type]" placeholder="Select FOB Currency" style="width:100%">
                                                        <option value="">Pilih Segel Kemas</option>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                        ...
                                        <tbody>
                                            <tr class="">
                                                <td class="p-1 ">
                                                    ...
                                                    <select name="memorizations[0][type]" class="form-control select2" id="memorizations[0][type]" placeholder="Select FOB Currency" style="width:100%">
                                                        <option value="">Pilih Segel Kemas</option>
                                                            <option value="1" >TPS MERAH</option>
                                                            <option value="2" >TPS HIJAU</option>
                                                            <option value="3" >LOCK SEAL</option>
                            ...
                            <hr>
                            <h5 class="mt-4">Upload Dokumen & Foto</h5>
                            <i class="tx-danger tx-11">(Ekstention File : jpeg, png, jpg, .pdf)</i>
                            <div class="form-group mt-4">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <label for="" class="text-black">
                                        ...
                                        <br><i class="text-info text-sm-left">Maksimum: 5MB</i>
                                        <input type="file" name="files_doc_hpl[]" id="files" class="form-control" multiple>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <label for="" class="text-black">
                                            Foto Pemeriksaan Barang
                                        ...
                                        <br><i class="text-info text-sm-left">Maksimum: 5MB</i>
                                        <input type="file" name="files_foto_pemeriksaan[]" id="files" class="form-control" multiple>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mt-2">
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <br><i class="text-info text-sm-left">Maksimum: 10MB</i>
                                        <input type="file" name="files_foto_pengawasan[]" id="files" class="form-control" multiple>
                                    </div>
                                </div>
                            </div>
                        </div>
