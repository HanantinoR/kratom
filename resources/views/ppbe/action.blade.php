<div class="flex align-items-center list-user-action">
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <a href="{{route('ppbe.show',$id)}}" class="btn btn-sm btn-icon btn-info">
        ...
        <div class="col-lg-12 col-md-12 mt-2">
            <a href="#" class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="Batal" onclick="openPPBEBatalModal({{ $id }}, '{{ $code }}')">
                <svg width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="me-2">
                    <path opacity="0.4" d="M16.34 1.99976H7.67C4.28 1.99976 2 4.37976 2 7.91976V16.0898C2 19.6198 4.28 21.9998 7.67 21.9998H16.34C19.73 21.9998 22 19.6198 22 16.0898V7.91976C22 4.37976 19.73 1.99976 16.34 1.99976Z" fill="currentColor"></path>
