...
class BcopsUmumDataTable extends DataTable
{
    /**
    ...
    {
        $model = BcopsUmumModel::leftjoin("bcops_red_seal","bcops_red_seal.id","=","bcops_umum.red_seal_id")
                                ->leftjoin("bcops_green_seal","bcops_green_seal.id","=","bcops_umum.green_seal_id")
                                ->leftjoin("bcops_lock_seal","bcops_lock_seal.id","=","bcops_umum.lock_seal_id")
                                ->leftjoin("bcops_thread_seal","bcops_thread_seal.id","=","bcops_umum.thread_seal_id")
                                ->select("bcops_umum.date_seal")
                                ->selectRaw("CONCAT(
                                    CASE
                                ...
                                ->orderBy("bcops_umum.created_at","desc")
    ...
    protected function getColumns()
    {
        return [
            ...
            ['data' => 'date_seal', 'name' => 'date_seal', 'title' => 'Tanggal','searchable'=>false],
