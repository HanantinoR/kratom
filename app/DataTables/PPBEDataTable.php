    ...
    public function dataTable($query, Request $request)
    {
        ...
        return datatables()
            ...
            ->editColumn('status', function($query) {
                ...
                if($status == "cancel")
                {
                    $status_cancel = 'Di Batalkan '.date("d-m-Y H:i:s", strtotime($query['updated_at']));
                    $merk_status .= $danger. $danger_icon.$status_cancel.'</span><br>';
                }
                else if($status == 'rejected'){
                    $status_reject = 'Di Tolak '.date("d-m-Y H:i:s", strtotime($query['updated_at']));
                    $merk_status .= $danger. $danger_icon.$status_reject.'</span><br>';
